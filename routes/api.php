...
use App\Http\Controllers\API\FuelpriceminingController;
...
use App\Http\Controllers\API\StructurepriceminingController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::resource('structurepricemining', StructurepriceminingController::class);
    Route::resource('statestructureprice', StateStructurepriceController::class);
    Route::resource('fuelprice', FuelpriceController::class);
    Route::resource('fuelpricemining', FuelpriceminingController::class);
