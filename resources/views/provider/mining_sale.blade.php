@extends('layouts.app')
@section('title', 'Ventes Sociétés minières')
@section('bg-class', 'bg-img-3')
@section('body')
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <div class="">
                <h2 class="font-weight-bold">Ventes liées aux Sociétés Minières</h2>
                <p class="lead small m-0">Gestion des ventes (sorties) liées aux sociétés minières </p>
            </div>
            <div class="m-2">
